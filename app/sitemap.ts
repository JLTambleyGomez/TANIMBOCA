...
const pageConfig: Record<HreflangRouteKey, { priority: number; changeFrequency: MetadataRoute.Sitemap[0]["changeFrequency"] }> = {
  ...
  "extras/anfibios": { priority: 0.9, changeFrequency: "weekly" },
  "extras/investigacion": { priority: 0.9, changeFrequency: "weekly" },
  "extras/aves": { priority: 0.9, changeFrequency: "weekly" },
  "extras/peces-ornamentales": { priority: 0.9, changeFrequency: "weekly" },
