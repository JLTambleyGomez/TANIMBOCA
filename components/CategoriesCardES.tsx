    ...
    >
      ...
      <div className="grid md:grid-cols-4 gap-6 p-6 max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-white mb-4">
            Mucho más que un viaje: es un encuentro auténtico con la diversidad
            cultural. Comparte tradiciones, lenguas, gastronomía y la visión del
            mundo de comunidades indígenas.
          </p>
          <Link
            href="/es/categorias/ethno-travel"
            className="inline-block bg-[#08837D] hover:bg-[#17c2b9] text-white px-4 py-2 rounded-xl transition"
          >
            Ver detalles
          </Link>
