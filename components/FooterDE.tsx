  ...
  return (
    <footer id="footer" className="bg-[#08837D] text-gray-100 py-10 px-6 md:px-12 mt-16">
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 items-start">
        <div>
          <Image src="/logo.png" alt="Tanimboca Logo" width={140} height={60} className="mb-4" />
        ...
        <div>
          <h3 className="text-lg font-semibold mb-3">Folge uns</h3>
      ...
      <div className="text-center text-xs mt-8 border-t border-[#0a6a66] pt-4">
        © {new Date().getFullYear()} Tanimboca. Alle Rechte vorbehalten.
      </div>
    </footer>
  );
}
